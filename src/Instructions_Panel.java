...
public class Instructions_Panel extends JPanel {
 ...
 //instructions in a jTextArea

	private JLabel ititle = new JLabel("Instructions");
 //text for title
 ...
 //Constructer
		...
		ititle.setBounds(300, 80, 470, 100);
 //sets location of title
		ititle.setFont(new Font(Back_Panel.getFontStyle(), Font.ITALIC, 50));
 //changes font of title
 ...
 //creates ok button
		...
		getbOk().setBounds(600,600,150,50);
 //sets location of ok button
		getbOk().setIcon(new ImageIcon("images/ReturnButton.png"));
 //set icon image
		getbOk().setHorizontalTextPosition(AbstractButton.CENTER);
 //set text location
		...
		InstructionLabel.setBounds(300,180,250,50);
 //sets location of instructions
